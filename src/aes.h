...
// Key setup must be done before any AES en/de-cryption functions can be used.
 ERAPI void aes_key_setup(const BYTE key[],          // The key, must be 128, 192, or 256 bits
                   WORD w[],                  // Output key schedule to be used later
                   int keysize);              // Bit length of the key, 128, 192, or 256

 ERAPI void aes_encrypt(const BYTE in[],             // 16 bytes of plaintext
                 BYTE out[],                  // 16 bytes of ciphertext
                 const WORD key[],            // From the key setup
                 int keysize);                // Bit length of the key, 128, 192, or 256

 ERAPI void aes_decrypt(const BYTE in[],             // 16 bytes of ciphertext
...
// AES - CBC
///////////////////
 ERAPI int aes_encrypt_cbc(const BYTE in[],          // Plaintext
...
// Only output the CBC-MAC of the input.
 ERAPI int aes_encrypt_cbc_mac(const BYTE in[],      // plaintext
                        size_t in_len,        // Must be a multiple of AES_BLOCK_SIZE
                        BYTE out[],           // Output MAC
                        const WORD key[],     // From the key setup
                        int keysize,          // Bit length of the key, 128, 192, or 256
...
// AES - CTR
///////////////////
 ERAPI void increment_iv(BYTE iv[],                  // Must be a multiple of AES_BLOCK_SIZE
                  int counter_size);          // Bytes of the IV used for counting (low end)

 ERAPI void aes_encrypt_ctr(const BYTE in[],         // Plaintext
 ...
 ERAPI void aes_decrypt_ctr(const BYTE in[],         // Ciphertext
                     size_t in_len,           // Any byte length
...
// Returns True if the input parameters do not violate any constraint.
 ERAPI int aes_encrypt_ccm(const BYTE plaintext[],              // IN  - Plaintext.
...
// ignores authentication explicitly if the first call failes.
 ERAPI int aes_decrypt_ccm(const BYTE ciphertext[],             // IN  - Ciphertext, the concatination of encrypted plaintext and MAC.
