...
namespace erebos {
	...
	namespace input {
		...
		enum class Key : INPUT_KEYTYPE {
			...
			KEY_KPCOMMA = 121,
			KEY_HANGEUL = 122,
			KEY_HANGUEL = static_cast<INPUT_KEYTYPE>(KEY_HANGEUL),
			KEY_HANJA = 123,
			KEY_YEN = 124,
			KEY_LEFTMETA = 125,
			KEY_RIGHTMETA = 126,
			...
			KEY_MSDOS = 151,
			KEY_COFFEE = 152,
			KEY_SCREENLOCK = static_cast<INPUT_KEYTYPE>(KEY_COFFEE),
			KEY_ROTATE_DISPLAY = 153,
			KEY_DIRECTION = static_cast<INPUT_KEYTYPE>(KEY_ROTATE_DISPLAY),
			...
			KEY_BRIGHTNESS_ZERO = static_cast<INPUT_KEYTYPE>(KEY_BRIGHTNESS_AUTO),
			KEY_DISPLAY_OFF = 245,
			KEY_WWAN = 246,
			KEY_WIMAX = static_cast<INPUT_KEYTYPE>(KEY_WWAN),
			KEY_RFKILL = 247,
			KEY_MICMUTE = 248,
			KEY_OK = 0x160,
			KEY_SELECT = 0x161,
			...
			KEY_BRIGHTNESS_TOGGLE = static_cast<INPUT_KEYTYPE>(KEY_DISPLAYTOGGLE),
			...
			KEY_DATA = 0x277,
			KEY_MIN_INTERESTING = static_cast<INPUT_KEYTYPE>(KEY_MUTE),
#endif
		};
