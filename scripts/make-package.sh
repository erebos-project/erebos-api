...
API_PACKAGE_PLACE_SHARED=true
API_PACKAGE_PLACE_HEADERS=true
API_PACKAGE_NAME_PATTERN="${API_PACKAGE_NAME}-${API_VMAJOR}-${API_VMINOR}-${API_VPATCH}-${API_TARGET_OS}-${API_TARGET_ARCH}"
